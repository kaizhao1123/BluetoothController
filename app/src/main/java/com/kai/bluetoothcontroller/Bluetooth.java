...
public class Bluetooth {
    ...
    public void sendMessage(int message) {
        ...
        Log.e("error", "======start to send");
        this.write(ByteBuffer.allocate(4).putInt(message).array());
    ...
    public void connectDevice(String deviceName) {
        ...
        try {
            ...
            Log.e("bluetooth","Unable to connect to device address "+ address + " " + e.getMessage());
        }
    }
